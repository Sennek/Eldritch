...
public struct AbsoluteDirection : IEquatable<AbsoluteDirection>
{
    ...
    public static Vector2Int NoneVector => new Vector2Int(0, 0);
    ...
    [Obsolete("Use NoneVector instead")]
    public static Vector2Int CenterVector => new Vector2Int(0, 0);

    public static AbsoluteDirection None => new AbsoluteDirection() { vector = NoneVector };
